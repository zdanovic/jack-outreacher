...
const translations = {
  en: {
    ...
    today: "Today",
    subtitle: "Key stats and today's highlights.",
    cold_sent: "Cold sent",
    replies: "Replies",
    hot: "Hot leads",
    warm: "Warm leads",
    ...
    chart_leads_sub: "Hot / warm / cold over time",
    ...
    metric_cold_hint: "Cold leads in pipeline",
  },
  ru: {
    dashboard: "Дашборд",
    leads: "Лиды",
    ...
    today: "Сегодня",
    subtitle: "Главные цифры и карточки за сегодня.",
    cold_sent: "Исходящие",
    replies: "Ответы",
    hot: "Hot-лиды",
    cold: "Cold-лиды",
    ...
    chart_leads: "Лиды",
    chart_leads_sub: "Hot / warm / cold по времени",
    ...
    metric_cold_hint: "Холодных лидов в работе",
  },
};
