...
const translations = {
  en: {
    ...
    settings_limits_interval: "Min interval between cold sends (s)",
    settings_limits_interval_hint: "Minimum seconds between cold sends per account (soft throttle)",
    settings_limits_hour: "Max cold per hour / account",
    settings_limits_hour_hint: "Soft cap per account per hour (0 disables)",
    ...
    settings_warmup_batch_night: "Batch interval at night (s)",
    settings_warmup_batch_night_hint: "Longer pauses during quiet hours",
    ...
    settings_warmup_quiet: "Quiet hours (start-end, local)",
    settings_warmup_quiet_hint: "Local hours when warmup is slowed down",
    settings_warmup_dialogs: "Max dialog reads per hour",
    settings_warmup_dialogs_hint: "Soft cap on dialog reads per hour",
  ...
  ru: {
    ...
    settings_limits_interval: "Мин. интервал между исходящими (с)",
    settings_limits_interval_hint: "Минимум секунд между исходящими для аккаунта (мягкий троттлинг)",
    settings_limits_hour: "Макс. исходящих в час / аккаунт",
    settings_limits_hour_hint: "Мягкий потолок на исходящие в час (0 — выкл.)",
    ...
    settings_warmup_batch_night: "Интервал ночью (с)",
    settings_warmup_batch_night_hint: "Более длинные паузы в тихие часы",
    ...
    settings_warmup_quiet: "Тихие часы (начало/конец, лок.)",
    settings_warmup_quiet_hint: "Локальные часы, когда прогрев замедляется",
    settings_warmup_dialogs: "Макс. чтений диалогов в час",
    settings_warmup_dialogs_hint: "Мягкий потолок на чтение диалогов в час",
